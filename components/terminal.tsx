        ...
        output: (
          <div className="space-y-2">
            ...
            <p className="font-mono text-white">
              Welcome to Adavya Sharma's portfolio! Type help to see available commands.
            </p>
          </div>
        ),
        timestamp: new Date(),
        ...
        output = (
          <div className="space-y-2 text-white">
            ...
            <ul className="space-y-1">
              <li>
                <span className="text-white font-bold">about</span> - Learn about Adavya
              </li>
              <li>
                <span className="text-white font-bold">resume</span> - View resume and educational background
              </li>
              <li>
    ...
    <div className="flex flex-col h-full">
      <div className="bg-black border border-white/30 rounded-t-md p-2 flex items-center">
        ...
        <span className="text-sm font-mono text-white">
          adavya@newtech ~ {currentSection ? `/${currentSection}` : ""}
        </span>
      </div>
